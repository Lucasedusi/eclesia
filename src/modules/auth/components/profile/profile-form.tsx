...
export function ProfileForm({ profile }: Props) {
  ...
  return <div className="grid gap-5 xl:grid-cols-[1fr_.36fr]">
    <form action={action} className="rounded-[20px] border border-[#EAECF0] bg-white p-6 shadow-[var(--shadow-card)]">
      ...
      <div className="mt-6 flex justify-end"><button disabled={pending} className="app-button-primary" type="submit"><Save size={16}/>{pending?"Salvando...":"Salvar perfil"}</button></div>
    </form>
