...
export function AuthShell({ children }: { children: React.ReactNode }) {
  return (
    <S.Page>
      ...
      <S.VisualPanel aria-label="Sobre o Eclesias">
        <S.VisualFrame>
          <S.VisualBrand>
            <S.VisualBrandMark><Building2 /></S.VisualBrandMark>
            <S.VisualBrandText>
              <strong>Eclesias</strong>
            ...
            <S.Preview aria-hidden="true">
              <S.PreviewTop>
                <div>
                  ...
                  <strong>Comunidade em movimento</strong>
                </div>
              ...
              <S.PreviewStats>
                <S.PreviewStat>
                  <Users size={20} />
                  <div><strong>1.284</strong><small>Membros</small></div>
                </S.PreviewStat>
                <S.PreviewStat>
                  <Building2 size={20} />
                  <div><strong>18</strong><small>Congregações</small></div>
                </S.PreviewStat>
                <S.PreviewStat>
                  <ShieldCheck size={20} />
                  <div><strong>100%</strong><small>Acesso protegido</small></div>
                </S.PreviewStat>
              </S.PreviewStats>
              <S.Bars>
...
export function AuthBrand({ alwaysVisible = false }: { alwaysVisible?: boolean }) {
  return (
    <S.Brand $alwaysVisible={alwaysVisible}>
