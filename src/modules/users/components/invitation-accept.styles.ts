...
export const Details = styled.div`display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:0 0 22px;text-align:left;div{border:1px solid #e7eaf1;border-radius: 6px;background:#fafbfc;padding:14px;}span{display:block;color:#98a2b3;font-size:10px;font-weight:750;}strong{display:block;margin-top:5px;color:#344054;font-size:12px;font-weight:850;}@media(max-width:480px){grid-template-columns:1fr;}`;
