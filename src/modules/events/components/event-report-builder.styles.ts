...
export const RadioCard = styled.label<{ $checked: boolean }>`
  ...
  input{position:absolute;opacity:0;} >span{display:grid;width:38px;height:38px;place-items:center;border-radius: 6px;background:${({$checked})=>$checked?"#415ba5":"#f0f2f5"};color:${({$checked})=>$checked?"#fff":"#667085"};}svg{width:17px;height:17px;}strong{display:block;color:#344054;font-size:11px;}small{display:block;margin-top:4px;color:#7c8798;font-size:9px;line-height:1.45;} >svg{color:#415ba5;}
`;

export const ReviewStats = styled.div`
  display:grid;grid-template-columns:repeat(auto-fit,minmax(125px,1fr));gap:8px;
  div{border:1px solid #e2e7f0;border-radius: 6px;background:#f8faff;padding:11px;}small{display:block;color:#7c8798;font-size:8px;}strong{display:block;margin-top:5px;color:#344e97;font-size:16px;}
