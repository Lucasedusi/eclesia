...
export const Identity = styled.div`display: flex; align-items: center; gap: 13px; > span { display: grid; width: 48px; height: 48px; place-items: center; border-radius: 6px; background: #415ba5; color: #fff; font-weight: 900; } h3 { margin: 0; color: #101828; font-size: 16px; font-weight: 900; } p { margin: 4px 0 0; color: #667085; font-size: 10px; font-weight: 650; }`;
...
export const Field = styled.div`border: 1px solid #e8ebf0; border-radius: 6px; background: #fbfcfd; padding: 11px 12px; dt { color: #98a2b3; font-size: 8px; font-weight: 850; text-transform: uppercase; } dd { margin: 4px 0 0; color: #344054; font-size: 11px; font-weight: 700; line-height: 1.45; word-break: break-word; }`;
...
export const FinanceSummary = styled.div`display: grid; grid-template-columns: 1fr 1fr; gap: 10px; article { border: 1px solid #e8ebf0; border-radius: 6px; background: #fbfcfd; padding: 13px; } small { color: #98a2b3; font-size: 8px; font-weight: 850; text-transform: uppercase; } strong { display: block; margin-top: 4px; color: #101828; font-size: 15px; }`;
...
export const Document = styled.article`display: flex; align-items: center; justify-content: space-between; gap: 12px; border: 1px solid #e8ebf0; border-radius: 6px; padding: 12px; h5 { margin: 0; color: #101828; font-size: 11px; font-weight: 850; } p { margin: 3px 0 0; color: #98a2b3; font-size: 9px; } > div:last-child { display: flex; gap: 6px; }`;
...
export const Error = styled.div`border: 1px solid #f2cbc8; border-radius: 6px; background: #fff5f4; padding: 13px; color: #a63f3a; font-size: 10px; font-weight: 700;`;
