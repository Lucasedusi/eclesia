...
export function DesignSystemToastTester() {
  ...
  return <>
    ...
    <div className="rounded-[6px] border border-[#EAECF0] bg-[#F9FAFB] p-4">
      <div className="mb-4"><h3 className="text-[calc(15px+var(--eclesia-font-size-adjustment))] font-semibold text-[var(--text-title)]">Teste temporário dos Toasts</h3><p className="mt-1 text-[calc(13px+var(--eclesia-font-size-adjustment))] font-normal leading-5 text-[var(--text-body)]">Clique em uma opção para manter o toast fixo na tela enquanto ajusta o estilo do componente.</p></div>
