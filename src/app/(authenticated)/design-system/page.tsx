    ...
    <div className="rounded-[6px] bg-white p-6 shadow-[var(--shadow-modal)]">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-[calc(18px+var(--eclesia-font-size-adjustment))] font-semibold text-[var(--text-title)]">
            {danger ? "Confirmação de Delete" : "Confirmação"}
          </h3>
          <p className="mt-1 text-[calc(14px+var(--eclesia-font-size-adjustment))] font-normal leading-6 text-[var(--text-body)]">
            {danger
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-3">
            <div className="rounded-[6px] border border-[#EAECF0] p-4">
              <p className="text-[calc(13px+var(--eclesia-font-size-adjustment))] font-semibold text-[#101828]">
                Cor principal
              </p>
              <p className="mt-1 text-[calc(13px+var(--eclesia-font-size-adjustment))] font-normal text-[#667085]">
                #415BA5
              </p>
            </div>
            <div className="rounded-[6px] border border-[#EAECF0] p-4">
              <p className="text-[calc(13px+var(--eclesia-font-size-adjustment))] font-semibold text-[#101828]">Sidebar</p>
              <p className="mt-1 text-[calc(13px+var(--eclesia-font-size-adjustment))] font-normal text-[#667085]">
                #071426
              </p>
            </div>
